...
public class SecurityConfig {
	...
	.requestMatchers("/modifierEtudiant","/supprimerEtudiant").hasAuthority("ADMIN")
	...
	@Bean
	 ...
	 return new InMemoryUserDetailsManager(admin, userMayssa,user1);
	 }
